...
TEST_CASE("CustomEigenWrapper Basic Functionality", "[eigen_wrapper]")
{
    ...
    SECTION("Initialization and Element Access")
    {
        ...
        auto eigen_wrapped_matrix = LazyMatrix::wrap_with_eigen(matrix);
    ...
    SECTION("Wrapping Result of Addition and Subtraction")
    {
        ...
        auto resultAdd = LazyMatrix::wrap_with_eigen(matrix1 + matrix2);
        auto resultSub = LazyMatrix::wrap_with_eigen(matrix1 - matrix2);
